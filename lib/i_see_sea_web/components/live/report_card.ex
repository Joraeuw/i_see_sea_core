  ...
  defp back_of_report(
    ...
    <div class="flex flex-col justify-around items-center  h-full w-full">
      ...
      <div class="flex flex-row items-center w-11/12 p-3 ml-[10px] bg-accent rounded-xl">
        ...
        <p class="p_card"><%= quantity %><p class="opacity-50 text-[0.9em]
        ">Quantity</p></p>
      </div>
      <div class="flex flex-row items-center  p-3 w-11/12 ml-[10px]  bg-accent rounded-xl">
        ...
        <p class="p_card"><%= species %><p class="opacity-50 text-[0.9em]
        ">Species</p></p>
      </div>
  ...
  defp back_of_report(
    ...
    <div class="flex flex-col justify-around  h-full w-full">
      ...
      <div class="flex flex-row items-center p-3 w-11/12 ml-[10px] bg-accent rounded-xl">
        ...
        <p class="p_card"><%= storm_type %><p class="opacity-50 text-[0.9em]
        ">Storm type</p></p>
      </div>
      <div class="flex flex-row align-middle p-3 w-11/12 ml-[10px] bg-accent rounded-xl">
  ...
  defp back_of_report(
    ...
    <div class="flex flex-col justify-around align-middle h-full w-full">
      ...
      <div class="flex flex-row items-center p-3 w-11/12 ml-[10px] bg-accent rounded-xl">
        ...
        <p class="p_card"><%= fog_type %> <p class="opacity-50 text-[0.9em]
        ">Fog type</p></p>
      </div>
      <div class="flex flex-row items-center p-3 w-11/12 ml-[10px] bg-accent rounded-xl">
        <img class="mr-[10px]" src="/images/report_icons/wind_type.svg" />
        <p class="p_card"><%= wind_type %> <p class="opacity-50 text-[0.9em]
        ">Wind type</p></p>
      </div>
      <div class="flex flex-row items-center p-3 w-11/12 ml-[10px] bg-accent rounded-xl">
        <img class="mr-[10px]" src="/images/report_icons/sea_swell.svg" />
        <p class="p_card"><%= sea_swell_type %> <p class="opacity-50 text-[0.9em]
        ">Sea swell type</p></p>
      </div>
      <div class="flex flex-row align-middle p-3 w-11/12 ml-[10px] bg-accent rounded-xl">
        <div class="felx felx-row h-3/3 w-1/2">
    ...
    <div class="flex flex-col justify-around align-middle h-full w-full">
      <div class="flex flex-row justify-center text-center card-title">Details:</div>
        ...
        <div class="flex flex-row items-center p-3 w-11/12 ml-[10px] bg-accent rounded-xl">
          ...
          <p class="p_card"><%= if has_oil, do: "Yes", else: "No" %> <p class="opacity-50 text-[0.9em]
          ">Oil pollution</p></p>
        </div>

      <div class="flex flex-row items-center p-3 w-11/12 ml-[10px] bg-accent rounded-xl">
        <img class="mr-[5px] bg-cover" src="/images/report_icons/plastic_icon.svg" />
        <p class="p_card" ><%= if has_plastic, do: "Yes", else: "No" %><p class="opacity-50 justify-end text-[0.9em]
        ">Plas. pollution</p></p>
      </div>
      <div class="flex flex-row items-center p-3 w-11/12 ml-[10px] bg-accent rounded-xl">
        <img class="mr-[10px]" src="/images/report_icons/biological_icon.svg" />
        <p class="p_card" ><%= if has_biological, do: "Yes", else: "No" %><p class="opacity-50 justify-end text-[0.9em]
        ">Bio. pollution</p></p>
      </div>

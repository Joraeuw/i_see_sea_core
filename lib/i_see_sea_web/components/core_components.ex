defmodule ISeeSeaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ISeeSeaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ISeeSeaWeb.Gettext, "errors", msg, opts)
    end
  end

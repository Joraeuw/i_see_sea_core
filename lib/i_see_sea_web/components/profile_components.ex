defmodule ISeeSeaWeb.ProfileComponents do
  ...
  def my_report_view(assigns) do
    ~H"""
    <div id="my_reports_container" class="flex flex-wrap justify-center gap-10 py-6 md:px-6 bg-gray-50 rounded-md shadow-md  mt-3 mb-6 w-[calc(100vw-5em)] mx-10 h-auto">

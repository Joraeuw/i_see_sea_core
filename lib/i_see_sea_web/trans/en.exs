[
  home: [
    ...
    success: "Success!",
    error: "Error!",
    no_internet: "We can't find the internet",
    attempt_to_reconnect: "Attempting to reconnect",
    ...
    close: "Close",
    processing_upload: "Processing images, please wait...",
    uploading: "Uploading"
  ],
  ...
  login: [
    ...
    sign_up: "Sign up",
    account_now: "for an account now.",
    email: "Email",
    password: "Password",
  ...
  register: [
    log_in: "Log in",
    account_now: "to your account now.",
    already_registered: "Already registered?",
    sth_went_wrong_check_errors: "Oops, something went wrong! Please check the errors below.",
  ...
  p_p: [
    ...
    website2:
      "By accessing our website, you accept our Privacy Policy and agree to its Terms of use (link).",
    website3:
    ...
    information_collected: "2. Information collected",
    info_collected_automatically: "Information collected automatically",
    information_provided: "Information you provide us by registering for an account",
    subscriber:
    ...
    privacy_children: "Privacy of children",
    website4:
    ...
    use_sharing: "Use and sharing of information",
    no_sell:
    ...
    security_measures:
      "We recommend that you check the Website periodically to stay updated on how we implement security measures designed to protect your information from unauthorized access. Your account is protected by your account password. We further protect your information from potential security breaches by implementing certain technological security measures. However, these measures do not guarantee that your information will not be accessed, disclosed, altered or destroyed by breach of such firewalls and secure server software. By using our Service, you acknowledge that you understand and agree to assume these risks.",
    user_rights: "User rights regarding the use of personal information",
    the_right:
    ...
    other_websites: "Link to other Websites",
    as_part:
    ...
    notify:
      "We reserve the right to change this policy and our Terms of Use at any time. We will notify you of Privacy Policy changes by sending an email to the contact information you have provided. Please check periodically the Website for updates.",
    cookies: "6. Cookies",
    website5:
      "ICC Website and Services may use third-party analytics tools that use cookies. The information is used to improve the users' experience and monitor the Website and Services' performance.",
    contact: "7. Contact",
    questions:
  ...
  t_c: [
    ...
    prohibited_activities: "5. PROHIBITED ACTIVITIES",
    may_not_access:
    ...
    ircumvent:
      "ircumvent, disable, or otherwise interfere with security-related features\n      of the Site, including features that prevent or restrict the use or\n      copying of any Content or enforce limitations on the use of the Site\n      and/or the Content contained therein.",
    disparage: "Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Site.",
    obtained:
    ...
    engage1: "Engage in unauthorized framing of or linking to the Site.",
    upload1:
    ...
    buying: "Use a buying agent or purchasing agent to make purchases on the Site.",
    collecting:
    ...
    advertise: "Use the Site to advertise or offer to sell goods and services.",
    transfer: "Sell or otherwise transfer your profile.",
    user_generated_contributions: "6. USER GENERATED CONTRIBUTIONS",
    terms4:
    ...
    false: "Your Contributions are not false, inaccurate, or misleading.",
    unsolicited:
    ...
    regulation: "Your Contributions do not violate any applicable law, regulation, or rule.",
    privacy:
    ...
    site_managment: "9. SITE MANAGEMENT",
    terms8:

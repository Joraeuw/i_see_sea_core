defmodule ISeeSeaWeb.ChangeLive do
  ...
  def render(assigns) do
    ...
    <div class="flex flex-col items-center justify-start w-full h-screen p-5">
      <div class="flex flex-col justify-between items-center  rounded-lg bg-no-repeat bg-cover w-11/12 max-w-[600px] h-auto
max-h-[800px]" style="background-image: url('/images/auth_icons/waveLoginReg.svg'); background-size: cover; background-position: center;">
        <form phx-submit="check_passwords" class="flex flex-col justify-between items-center w-full h-full rounded-lg bg-no-repeat bg-cover">
          ...
          <input id="new_password" class="my-3 imt-2 block w-7/12 rounded-lg text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6 phx-no-feedback:border-zinc-300 phx-no-feedback:focus:border-zinc-400 border-zinc-300 focus:border-zinc-400" type="password" name="new_password" value={@form_data["new_password"]} />

          <p class="text-[#189ab4] text-lg text-center">Confirm your new password:</p>
          <input id="confirm_password" class="my-3  mt-2 block w-7/12 rounded-lg text-zinc-900 focus:ring-0 sm:text-sm sm:leading-6 phx-no-feedback:border-zinc-300 phx-no-feedback:focus:border-zinc-400 border-zinc-300 focus:border-zinc-400" type="password" name="confirm_password" value={@form_data["confirm_password"]} />
